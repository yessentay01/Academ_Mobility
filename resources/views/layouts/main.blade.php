            ...
            <div :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
                ...
                <div class="flex items-center justify-center mt-8">
                    <div class="flex items-center">
                        <a href="/"> <span class="text-gray-800 dark:text-white text-2l font-semibold">IITU ACADEMIC MOBILITY</span></a>
                    </div>
                </div>
                ...
                <nav class="flex flex-col mt-10 ">
                    ...
                    @if(Auth::user()->is_admin)
                        ...
                        <a href="#!"
                           class="mt-3 px-4 py-2 text-sm text-gray-600  dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-100  hover:bg-gray-200 dark:hover:bg-gray-800 rounded">Reports</a>
            ...
            <div class="flex-1 flex flex-col overflow-hidden">
                <header class="flex justify-between items-center p-6">
                    <div class="flex items-center space-x-4 lg:space-x-0">
                        ...
                        <div>
                            <h1 class="text-2xl font-medium text-gray-800 dark:text-white">@yield('title')</h1>
                        </div>
                    </div>
...
{{--                        </button>--}}
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            <button @click="dropdownOpen = ! dropdownOpen"
                                ...
                                <img class="h-9 w-9 rounded-full border-2 border-blue-500 object-cover"
                                     src="{{auth()->user()->toArray()['profile_photo_path']}}"
                                     alt="Your avatar">
                            </button>
