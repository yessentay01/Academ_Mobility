...
@section('content')
    <div class="container">
        <div class="bg-white rounded p-6">
            <h2 class="text-lg font-medium leading-6 text-gray-900">Apply Status</h2>
            <!-- Modal toggle -->
        ...
        <!-- Main modal -->
        <div id="default-modal" data-modal-show="false" aria-hidden="false" class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
